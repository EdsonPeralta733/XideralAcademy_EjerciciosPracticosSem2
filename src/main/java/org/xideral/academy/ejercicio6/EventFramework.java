package org.xideral.academy.ejercicio6;
...
class OrderService {
    ...
    public void placeOrder(String orderId, double amount) throws OrderProcessingException {
        // TODO: validar amount > 0, si no lanzar excepcion
        if (amount <= 0) throw new OrderProcessingException("Monto invalido para orden " + orderId + ": $" + amount);
...
public class EventFramework {
    public static void main(String[] args) {
        ...
        bus.subscribe(EventType.ORDER_PLACED, data -> System.out.println("  [LOG] " + data));
        bus.subscribe(EventType.ORDER_SHIPPED, data -> System.out.println("  [LOG] " + data));
        bus.subscribe(EventType.ORDER_CANCELLED, data -> System.out.println("  [ALERTA] " + data));
