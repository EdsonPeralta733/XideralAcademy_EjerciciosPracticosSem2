package org.xideral.academy.ejercicio5;
...
class Pizza implements PizzaOrder {
    ...
    public String getDescription() {
        return String.format("Pizza %s, %s con %s", size, crust, toppings);
    }
    ...
    static class Builder {
        ...
        public Builder addTopping(String topping) {
            ...
            if (toppings.size() >= 5) throw new IllegalStateException("Maximo 5 toppings");
        ...
        public Pizza build() {
            ...
            if (toppings.isEmpty()) throw new IllegalStateException("Minimo 1 topping");
